...
namespace CapaPresentacion
{
    public partial class Categoria : Form
    {
        ...
        private void btn_guardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    if (this.IsNuevo)
                    {
                        respuesta = NCategoria.Insertar(this.txt_nombre.Text.Trim().ToUpper(),this.txt_descripcion.Text.Trim());
                    }
                    else
                    {
                        respuesta = NCategoria.Editar(Convert.ToInt32(this.txt_Idcategoria.Text),this.txt_nombre.Text.Trim().ToUpper(), this.txt_descripcion.Text.Trim());
                    }
        ...
        {
            ReporteCategoria frm = new ReporteCategoria();
            frm.ShowDialog();
        }
